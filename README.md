...
## Pretrained Models
We provide three pretrained models and corresponding training logs. These models generally perform better than the results reported in the paper because we report mean result of 5 runs with different random seeds in the paper while release the best model.
