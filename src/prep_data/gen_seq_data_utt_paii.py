...
np.save('seq_data_paiia/tr_label_utt.npy', tr_label)
...
np.save('seq_data_paiia/te_label_utt.npy', te_label)
...
tr_label = process_feat_seq_utt(tr_feat, tr_keys, tr_label, phn_dict, utt2score)
print(tr_label.shape)
np.save('seq_data_paiib/tr_label_utt.npy', tr_label)
...
te_label = process_feat_seq_utt(te_feat, te_keys, te_label, phn_dict, utt2score)
print(te_label.shape)
np.save('seq_data_paiib/te_label_utt.npy', te_label)
